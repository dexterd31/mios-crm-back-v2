...
class ReportManager
{
    ...
    public function consultReportData(array $data, $rrhhIdToNotify)
    {
        ...
        if ($formAnswers->count()) {
            ...
            // $this->buildReportDataStructure($formAnswerLogsIds, $plantillaRespuestas, $inputReport, $dependencies, $adviserInfo,  $titleHeaders, $data['formId'], $data['include_tipification_time'], $rrhhIdToNotify);
    ...
    public function buildReportDataStructure(array $formAnswerLogsIds, array $plantillaRespuestas, array $inputReport, array $dependencies, array $adviserInfo, array $titleHeaders, $formId, $includeTipificationTime, $rrhhIdToNotify)
    {
        $char="";
        $r = 0;
        $rows = [];
        ...
        $formName = Form::find($formId)->name_form;
