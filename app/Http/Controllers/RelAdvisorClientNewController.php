...
class RelAdvisorClientNewController extends Controller
{
    ...
    public function showAssignedClients(int $formId)
    {
        ...
        ->where('client_news.form_id', $formId)->where('rel_advisor_client_new.managed', false)->get(['client_news.created_at', 'rel_advisor_client_new.id']);
        ...
        ->managedFilter(false)->get(['created_at', 'id']);
