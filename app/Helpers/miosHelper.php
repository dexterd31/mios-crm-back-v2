...
class MiosHelper
{
    ...
    /**
     * @author: Joao Beleño
     * De un arreglo de objetos agrupa los datos por el nombre de objeto que se pase
     * @param $key (string) nombre del elemento del objeto que desea agrupar
     * @param $array (array) arreglo donde se encuentra los objetos y elementos a agrupar
     * */
    public function getArrayValues($key, $array)
    {
        ...
        foreach ($array as $value)
        {
            if(is_array($value))
            {
                if(!in_array($value[$key],$arrayValues)){
